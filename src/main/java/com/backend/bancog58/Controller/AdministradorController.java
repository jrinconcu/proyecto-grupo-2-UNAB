...
import com.backend.bancog58.Service.AdministradorService;
...
public class AdministradorController {
    ...
    @PostMapping(value="/")
    @ResponseBody
    public ResponseEntity<Administrador> agregar(@RequestHeader("clave")String clave,@RequestHeader("usuario")String usuario, @Valid @RequestBody Administrador dato){   
    ...
    @PutMapping(value="/") 
    @ResponseBody
    public ResponseEntity<Administrador> editar(@RequestHeader("clave")String clave,@RequestHeader("usuario")String usuario,@Valid @RequestBody Administrador dato){ 
        Administrador objeto=new Administrador();
        objeto=dao.login(usuario, Hash.sha1(clave));
        if (objeto!=null) {
