...
import com.backend.bancog58.Models.Cuenta;
import com.backend.bancog58.Security.Hash;
//import com.backend.bancog58.Dao.CuentaDao;
import com.backend.bancog58.Service.CuentaService;
...
public class CuentaController {
   //@Autowired
    ...
    @PostMapping(value="/")
    public ResponseEntity<Cuenta> agregar(@RequestHeader("clave")String clave,@RequestHeader("usuario")String usuario,@Valid@RequestBody Cuenta dato){   
