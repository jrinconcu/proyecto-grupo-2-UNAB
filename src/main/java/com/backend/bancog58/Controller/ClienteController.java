...
import com.backend.bancog58.Service.ClienteService;
...
public class ClienteController {
    ...
    @PostMapping(value="/")
    @ResponseBody
    public ResponseEntity<Cliente> agregar(@RequestHeader("clave")String clave,@RequestHeader("usuario")String usuario, @Valid @RequestBody Cliente dato){   
    ...
    @PutMapping(value="/") 
    @ResponseBody
    public ResponseEntity<Cliente> editar(@RequestHeader("clave")String clave,@RequestHeader("usuario")String usuario,@Valid @RequestBody Cliente dato){ 
        Cliente objeto=new Cliente();
        objeto=dao.login(usuario, Hash.sha1(clave));
        if (objeto!=null) {
            dato.setClave_cliente(Hash.sha1(dato.getClave_cliente()));
